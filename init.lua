...
vim.keymap.set('n', 'n', 'nzzzv', { remap = true, desc = 'Next search result' })
vim.keymap.set('n', 'N', 'Nzzzv', { remap = true, desc = 'Previous search result' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers =
        { 'bash', 'c', 'diff', 'go', 'gomod', 'gowork', 'python', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
